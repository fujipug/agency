...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='gift',
            field=models.CharField(default=b'T-shirt', max_length=10, choices=[(b'T-shirt', b'T-shirt'), (b'Sticker', b'Sticker'), (b'Keychain', b'Keychain')]),
